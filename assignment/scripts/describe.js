...
// we moved down and check the else-if to see if isStudent (true) is equal to false or the student is under 30 years old. 
// CORRECTION : OR statement is incorrect/FALSE. isStudent is not === false nor is the student under 30
// we then move down to the 'esle if' statement which remains true and the browswer logs 'Welcome to Prime'
...
// needed to assign colorOne and colorTwo as 'purple' (lines 155+156) now it logs to 'they are purple'
// fixed code below lines 151 - 163
